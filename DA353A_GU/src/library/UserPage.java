...
public class UserPage extends JPanel implements ActionListener {
    ...
    public UserPage(LibraryController libC) {
        ...
        borrowBtn.addActionListener(e -> {
            // /*
            // * Lägg till en try-catch om Integer.parseInt får fnatt?
            // */
            // try {
            // String str = mediaIDTxtF.getText();
            // if (str == null) {
            // throw new NullPointerException();
            // }
            // Integer mediaId = Integer.parseInt(str);
            // libraryController.borrow(mediaId);
            // } catch (NumberFormatException except) {
            // // Hjälpfullt meddelande i JOptionPane?
            // } catch (NullPointerException except) {
            // // Mer hjälpfulla meddelande?
            // }
